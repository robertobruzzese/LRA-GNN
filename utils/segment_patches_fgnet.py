...
# === Percorsi ===
preprocessed_dir = "datasets/data/FGNET/images/Train/images_preprocessed"
points_dir = "datasets/data/FGNET/points_reduced"
patches_dir = "datasets/data/FGNET/patches"
segmented_dir ="datasets/data/FGNET/images/Train/images_segmented"
