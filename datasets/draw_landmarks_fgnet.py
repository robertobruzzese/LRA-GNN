...
IMAGE_DIR = "datasets/data/FGNET/images/Train/images_preprocessed/"  # Cartella con le immagini originali
POINTS_DIR = "datasets/data/FGNET/points"        # Cartella con i file .pts originali (68 punti)
REDUCED_POINTS_DIR = "datasets/data/FGNET/points_reduced"  # Cartella con i file .pts ridotti (PCA)
OUTPUT_DIR_FULL = "datasets/data/FGNET/images/Train/landmarked"  # Per le immagini con 68 landmark
OUTPUT_DIR_REDUCED = "datasets/data/FGNET/images/Train/landmarked_reduced"  # Per i landmark ridotti
