...
IMAGE_DIR = "datasets/data/MORPH/images/Train/images_preprocessed"  # ✅ Ora lavora su immagini preprocessate!
POINTS_DIR = "datasets/data/MORPH/points"
REDUCED_POINTS_DIR = "datasets/data/MORPH/points_reduced"
